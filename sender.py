"""
Telegram message sender for Degree Jobs Fresher Bot
Formats job info and sends to channel - optimized like US Tax bot
"""
import requests
import re
import time
...
def send_startup_message(keyword_count, location_count):
    ...
    msg = (
        "👋 *Welcome to Degree Jobs Fresher — Hyderabad & Telangana*\n\n"
        "🎯 This channel posts *fresh fresher job openings* every 10 minutes — "
        "automatically sourced from LinkedIn, Workday, India Job Portals and company sites.\n\n"
        "🎓 *Degrees Covered:*\n"
        "• Any Bachelor's or Master's Degree\n"
        "• B.A., B.Sc., B.Com., BBA, BCA, B.Ed., BSW, MBA, M.Sc., M.Com., MCA\n"
        "• All specializations\n\n"
        "💼 *Focus Areas:*\n"
        "• PRIMARY: TAX jobs (Income Tax, Tax Compliance, Tax Assistant)\n"
        "• SECONDARY: All entry-level roles (Finance, Banking, BPO, IT, etc.)\n\n"
